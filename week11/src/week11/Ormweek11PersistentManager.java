...
public class Ormweek11PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ormweek11";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Ormweek11PersistentManager();
		}
