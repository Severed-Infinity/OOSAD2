...
public class EmployeeDAO {
	public static Employee loadEmployeeByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = week11.Ormweek11PersistentManager.instance().getSession();
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Employee) session.load(week11.Employee.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee getEmployeeByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Employee) session.get(week11.Employee.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee loadEmployeeByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.load(week11.Employee.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Employee getEmployeeByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Employee) session.get(week11.Employee.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEmployee(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From week11.Employee as Employee");
		if (condition != null)
	...
	public static Employee createEmployee() {
		return new week11.Employee();
	}
	
	public static boolean save(week11.Employee employee) throws PersistentException {
		try {
			week11.Ormweek11PersistentManager.instance().saveObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(week11.Employee employee) throws PersistentException {
		try {
			week11.Ormweek11PersistentManager.instance().deleteObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(week11.Employee employee) throws PersistentException {
		try {
			week11.Ormweek11PersistentManager.instance().getSession().refresh(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(week11.Employee employee) throws PersistentException {
		try {
			week11.Ormweek11PersistentManager.instance().getSession().evict(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
